...
import { Save, X, Upload, File, FileText, Trash2, Video } from 'lucide-vue-next';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Editar', href: `/materials/${props.material.id}/edit` }
];
            ...
            <div class="p-6 border-b bg-white rounded-[15px] pb-4">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p class="text-gray-500 mt-1">Actualiza la información del material</p>
                    </div>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="p-6 border-b bg-white rounded-[15px]">
                ...
                <div v-if="form.type === 'video'" class="grid grid-cols-1 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <!-- Archivo actual del servidor -->
                        <div v-if="material.file_path && !selectedFileName" class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-xs text-gray-600">
                                        {{ material.original_filename || material.file_path.split('/').pop() }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div v-if="!selectedFileName"
                            ...
                            @drop="handleDrop"
                            class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center cursor-pointer transition-all duration-200 hover:border-blue-500 hover:bg-blue-50/50"
                            :class="{
                        ...
                        >
                            <div class="flex flex-col items-center gap-3">
                                <div class="p-3 bg-blue-100 rounded-full" :class="{ 'bg-blue-200': isDragging }">
                                    <Upload class="h-6 w-6 text-blue-600" :class="{ 'animate-bounce': isDragging }" />
                                </div>
                                <div>
                                    <p class="text-sm font-medium text-gray-700">
                                        {{ isDragging ? '¡Suelta el archivo aquí!' : 'Haz clic para cambiar el video' }}
                                    </p>
                        ...
                        <p v-else class="text-xs text-gray-500 mt-1">{{ selectedFileName ? 'Este archivo reemplazará al actual' : 'Deja vacío para mantener el archivo actual' }}</p>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        >
                            <div class="flex flex-col items-center gap-3">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-gray-700">
                                        {{ isDragging ? '¡Suelta el archivo aquí!' : 'Haz clic para cambiar el PDF' }}
                                    </p>
                                    <p class="text-xs text-gray-500 mt-1">
                                        {{ isDragging ? '' : 'o arrastra y suelta aquí' }}
                                    </p>
                    ...
                    <div>
                        ...
                        >
                            <div class="flex flex-col items-center gap-3">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-gray-700">
                                        {{ isDragging ? '¡Suelta el archivo aquí!' : 'Haz clic para cambiar el archivo' }}
                                    </p>
                                    <p class="text-xs text-gray-500 mt-1">
                                        {{ isDragging ? '' : 'o arrastra y suelta aquí' }}
                                    </p>
                ...
                <div class="flex items-center justify-end gap-4">
                    ...
                    >
                        <Save class="h-5 w-5"/>
                        <span>{{ form.processing ? 'Guardando...' : 'Actualizar' }}</span>
                    </button>
                </div>
            </form>
        </div>
